...
local function create_tags(elem_name, items, tag_path)
    local ttag = {}
    ...
    tags:CreateNewTags(ttag, {pth_dir=tag_path})
end
...
do --  Класс Кнопка-кликер.
    ...
    function Btn_click:new(name, tag_path)
        ...
        create_tags(name, {"cmd", "unlock", "q"}, tag_path)
