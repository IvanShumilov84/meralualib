...
-- TODO Добавить в ALARM_CLASS значение warn_error - тревога с предаварийной и аварийной уставками.
-- TODO Добавить обработку LOGIC = change.
-- TODO Добавить задержку обработки тревоги на время delay.
-- TODO Для каналов LOGIC = discrete, analog , change - добавить проверку на существование каналов в СИАМ с именем channel. Выводить ошибку в эту же таблицу при отсутствии или неисправности канала.
-- TODO Для ch_low, ch_high - добавить проверку на существование каналов в СИАМ. Выводить ошибку в эту же таблицу при отсутствии или неисправности каналов.
